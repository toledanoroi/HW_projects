 ...
 * sd - the socket used for communication.
 */ 
TransferResult_t SendString1( const char *Str, SOCKET sd );

/**
 * Accepts:
 * -------
 * ReceiveBuffer1() uses a socket to receive a buffer.
 ...
 * TRNS_FAILED - otherwise
 */ 
TransferResult_t ReceiveBuffer1( char* OutputBuffer, int RemainingBytesToReceive, SOCKET sd );

/**
 * ReceiveString1() uses a socket to receive a string, and stores it in dynamic memory.
 * 
 * Accepts:
 * -------
